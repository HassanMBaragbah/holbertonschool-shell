...
This directory contains shell scripts that demonstrate basic Linux navigation, file management, and directory listing commands.
...
| `17-tree` | Creates a directory structure `welcome/to/school` using exactly two spaces in the script. |